...
private fun getCircleColor(
    ...
    val colorId =
        App.instance.resources.getIdentifier(colorIdName, "color", App.instance.packageName)
    return App.instance.resources.getColor(colorId)
}

fun getGreyCircleDrawable(): Drawable {
    return getColoredCircleDrawable(App.instance.resources.getColor(R.color.light_gray))
}

private fun getColoredCircleDrawable(@ColorInt color: Int): Drawable {
    val drawable = App.instance.resources.getDrawable(R.drawable.circle_shape) as GradientDrawable
